...
![Discord Bot License Claim](/assets/images/license_claim4.png)

With your key(s) displayed, click the Copy button to the right of the license(s) field, or simply copy the text manually.

![Discord Bot License Claim](/assets/images/license_claim5.png)