...
This section lists all globally available **Custom Data Structures (Types)**. These are exposed as constructors (e.g., `Vector3.new()`) and contain various properties and methods (`:method()`) essential for working with game and graphics data.