...
```lua
set_water_color(number: address, Color3: value)
```
...
```lua
set_grass_size(number: address, number: value)
```
...
```lua
set_water_reflect(number: address, number: value)
```
...
```lua
set_wave_size(number: address, number: value)
```
...
```lua
set_wave_speed(number: address, number: value)
```
...
```lua
set_decoration(number: address, boolean: value)
```
...
set_ambient(number: address, Color3: value)
...
set_shift_bottom(number: address, Color3: value)
...
set_shift_top(number: address, Color3: value)
...
set_fog_color(number: address, Color3: value)
...
set_outdoor_ambient(number: address, Color3: value)
...
set_brightness(number: address, number: value)
...
set_diffuse_scale(number: address, number: value)
...
set_specular_scale(number: address, number: value)
...
set_exposure(number: address, number: value)
...
set_fog_end(number: address, number: value)
...
set_fog_start(number: address, number: value)
...
set_shadow_softness(number: address, number: value)
...
set_technology(number: address, number: value)
...
set_global_shadows(number: address, boolean: value)
...
set_tint(number: address, Color3: value)
...
set_direction(number: address, number: value)
